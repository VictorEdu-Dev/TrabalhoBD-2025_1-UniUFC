...
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id, professor_secondary_id)
    VALUES (16, 'Mecânica dos Materiais', 'EEL014', 'Introdução à Mecânica dos Materiais. Estruturas Isostáticas. Propriedades Geométricas das Seções. Tensões e Deformações. Tração e Compressão. Torção. Flexão em Vigas. Cisalhamento Puro. Cabos. Aplicações em Engenharia Elétrica.',
        4, 'OBRIGATORIA', 2, 9, 2); -- Professor Primary: Luis Eduardo Araripe, Professor Secondary: Ricardo Pires dos Santos
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (17, 'Variáveis Complexa', 'EEL017', 'Funções complexas. Condições de Cauchy-Riemann. Fórmula integral de Cauchy. Série de Laurent. Teorema dos resíduos. Transformação conforme. Aplicações em Engenharia Elétrica',
        4, 'OBRIGATORIA', 2, 15); -- Professor Primary: Juan Carlos Peqquena Suni
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (18, 'Eletrônica Digital', 'EEL019', 'Sistemas de Numeração e Códigos. Portas Lógicas e Algebra Booleana. Circuitos Lógicos Combinacionais. Flip-Flops e Dispositivos Correlatos. Aritmética Digital: Operações e Circuitos. Contadores e Registradores. Contadores e Registradores. Circuitos Lógicos MSI. Interface com o Mundo Analógico. Dispositivos de Memória. Aplicações de um Dispositivo de Lógica Programável.',
        6, 'OBRIGATORIA', 2, 13); -- Professor Primary: Rômulo Nunes de Carvalho Almeida
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (19, 'Elementos de Fenômenos de Transporte', 'EEL020', 'Conceitos fundamentais. Equações gerais da cinemática e dinâmica dos fluidos. Equações básicas para conservação de massa, momentum e energia. Escoamento externo e Interno. Transferência de calor. Condução, convecção radiação. Aplicações.',
        4, 'OBRIGATORIA', 2, 10); -- Professor Primary: José Valdenir Silveira
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (20, 'Circuitos Elétricos I', 'EEL021', 'Introdução, definições, leis experimentais, circuitos simples. Técnicas básicas de análise de circuitos. Circuitos usando amplificadores operacionais. Indutância e capacitância. Circuitos RL e RC. Resposta de circuitos à função senoidal. Os conceitos de fasor, impedância e admitância. Resposta de circuitos em regime permanente senoidal.',
        6, 'OBRIGATORIA', 2, 11); -- Professor Primary: Rui Facundo Vigelis
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id, professor_secondary_id)
    VALUES (21, 'Eletromagnetismo Aplicado', 'EEL024', 'Análise vetorial. Campos elétricos estacionários. Energia e potencial. Materiais elétricos. Capacitancia. Equações de Poisson e Laplace. Campos magnéticos estacionários. Materiais magnéticos. Indutância e força magnética. Campos variáveis no tempo e equações de Maxwell. Propagação de ondas eletromagnéticas.',
        6, 'OBRIGATORIA', 2, 17, 9); -- Professor Primary: Euclimar Passos da Silva, Professor Secondary: Luis Eduardo Araripe
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (22, 'Microprocessadores', 'EEL022', 'O microprocessador como elemento da arquitetura básica de um computador digital. Microprocessadores, memória, dispositivos de entrada/saída, ciclos de máquina, conceito de interrupções, DMA. Conjunto de instruções assembly, montadores, programadores e simuladores. Exemplos de familias de Microprocessadores. exemplos de aplicações.',
        6, 'OBRIGATORIA', 2, 13); -- Professor Primary: Rômulo Nunes de Carvalho Almeida
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (23, 'Sistemas Lineares', 'EEL025', 'Sinais e Sistemas. Sistemas lineares invariantes no tempo. Representação de Fourier para sinais e sistemas de tempo contínuo e de tempo discreto. Amostragem de sinais. Caracterização de sistemas por meio da transformada de Laplace e da transformada Z. Representação e análise de sistemas no espaço de estados. Aplicações em sistemas com realimentação.',
        4, 'OBRIGATORIA', 2, 13); -- Professor Primary: Rômulo Nunes de Carvalho Almeida
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (24, 'Eletrônica Analógica', 'EEL026', 'Diodos Semicondutores. Aplicações do Diodo. Transitores Bipolares de Tensão. Polarização CC - TBJ. Transitores de Efeitos de Campo. Polarização do FET. Modelagem do Transitor TBJ. Análise do TBJ para Pequenos Sinais. Análise do FET para Pequenos Sinais. Análise de Sistemas - Efeito de Rs e Rl. Resposta em Freqüência do TBJ e JFET. Configurações Compostas. Amplificadores Operacionais. Amplificações do AMP-OP. Amplificadores de Potência. Cls Lineares/Digitais. Realimentação e Circuitos Osciladores. Fontes de Tensão (Reguladores de Tensão). Outros Dispositivos de Dois Terminais. pnpn e Outros Dispositivos. Osciloscópios e Outros Instrumentos de Medida.',
        6, 'OBRIGATORIA', 2, 17); -- Professor Primary: Euclimar Passos da Silva
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (25, 'Circuitos Elétricos II', 'EEL027', 'Algebra Vetorial. Fundamentos Matemáticos da Senóide. Circuitos Básicos em CA. Potência em Circuitos CA. Ressonância Série e Paralela. Circuitos Polifásicos Equilibrados. Circuitos Trifásicos Desequilibrados. Ondas Não-Senoidais.',
        6, 'OBRIGATORIA', 2, 16); -- Professor Primary: José Cláudio do Nascimento
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (26, 'Instrumentação, Medidas e Instalações Elétricas', 'EEL018', 'Grandezas Elétricas. Produção de Força Eletromotriz. Principais Tipos de Circuitos de Corrente Alternada. Principais Tipos de Ligação. Tecnologia dos Equipamentos e Dispositivos de Instalações Elétricas Residenciais e Respectivos Símbolos Normalizados. Circuitos Fundamentais de Instalações Elétricas Residenciais. principais tópicos da NBR 5410/1997.',
        4, 'OBRIGATORIA', 2, 14); -- Professor Primary: Rosana Maria Alves Saboya
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (27, 'Engenharia dos Materiais', 'EEL033', 'Estrutura dos materiais. Comportamento Mecânico. Processo termomecânico. Classes de Materiais. Seleção de materiais e considerações de projeto.',
        4, 'OBRIGATORIA', 2, 14); -- Professor Primary: Rosana Maria Alves Saboya

-- Disciplinas de Engenharia Elétrica (Optativas)
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (28, 'Fontes Alternativas de Energia', 'EEL044', 'Recurso eólico. Gerador eólico. Sistemas eólicos autónomos. Sistemas eólicos interligados à rede elétrica. Uso de ferramentas computacionais para modelagem de sistemas eólio-elétricos. Aspectos económicos dos projetos eólicos. Recurso solar. Células fotovoltaicas. Componentes básicos de uma instalação fotovoltaica. Sistemas fotovoltaicos autónomos. Sistemas fotovoltaicos interligados à rede elétrica. Uso de ferramentas computacionais para modelagem de sistemas fotovoltaicos. Biomassa: principios de conversão. Tecnologia de gaseificação. Biodigestores.',
        4, 'OPTATIVA', 2, 10); -- Professor Primary: José Valdenir Silveira
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (29, 'Produção de Energia Elétrica', 'EEL045', 'Energia e desenvolvimento. Formas de conversão de energia convencional e alternativa. Controle de potência ativa, reativa, tensão e freqüência. Aplicações e dimensionamento. Geração distribuída.',
        4, 'OPTATIVA', 2, 12); -- Professor Primary: Nilena Brito Maciel Dias
INSERT INTO disciplina (id, nome, codigo, ementa, creditos, tipo, curso_id, professor_primary_id)
    VALUES (30, 'Planejamento Energético', 'EEL046', 'Visão global do planejamento energético. Modelo de planejamento energético. Planejamento a longo, médio e curto prazo. Planejamento do setor elétrico como parte do planejamento global do sistema energético. Estrutura de um mercado de energia elétrica, projeção de demanda, planejamento indicativo da expansão do sistema, acesso à transmissão, regulação técnica e econòmica de sistemas de energia elétrica. Fundamentos de previsão de demanda. Técnicas de previsão alternativas. Planejamento energético integrado de uma nação. Avaliação comparativa de diferentes fontes de energia elétrica. Visão geral de metodologias de previsão de futuro.',
        4, 'OPTATIVA', 2, 12); -- Professor Primary: Nilena Brito Maciel Dias
...
INSERT INTO disciplina_prerequisito (disciplina_requerente_id, disciplina_prerequisito_id) VALUES (24, 20); -- Eletrônica Analógica requer Circuitos Elétricos I
INSERT INTO disciplina_prerequisito (disciplina_requerente_id, disciplina_prerequisito_id) VALUES (25, 20); -- Circuitos Elétricos II requer Circuitos Elétricos I
INSERT INTO disciplina_prerequisito (disciplina_requerente_id, disciplina_prerequisito_id) VALUES (26, 20); -- Instrumentação, Medidas e Instalações Elétricas requer Circuitos Elétricos I
INSERT INTO disciplina_prerequisito (disciplina_requerente_id, disciplina_prerequisito_id) VALUES (28, 19); -- Fontes Alternativas de Energia requer Elementos de Fenômenos de Transporte
INSERT INTO disciplina_prerequisito (disciplina_requerente_id, disciplina_prerequisito_id) VALUES (29, 21); -- Produção de Energia Elétrica requer Eletromagnetismo Aplicado
INSERT INTO disciplina_prerequisito (disciplina_requerente_id, disciplina_prerequisito_id) VALUES (30, 21); -- Planejamento Energético requer Eletromagnetismo Aplicado
